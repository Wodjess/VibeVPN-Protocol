...
type Props = {
  visible: boolean;
  onClose: () => void;
  onAdd: (server: { name: string; host: string; port: number; username: string; password: string }) => void;
};

export default function AddServerModal({ visible, onClose, onAdd }: Props) {
